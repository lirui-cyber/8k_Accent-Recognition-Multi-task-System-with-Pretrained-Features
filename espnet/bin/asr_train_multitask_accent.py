...
def get_parser(parser=None, required=True):
    ...
    # multi-task accent 
    parser.add_argument("--asrWeight", type=float, default=1.0, help="ASR weight in Multi-task system")
    parser.add_argument("--accentWeight", type=float, default=1.0, help="Accent weight in Multi-task system")
    parser.add_argument("--NumClass", type=int, default=8, help="Number of class")
    parser.add_argument("--utt2LabelTrain", type=str, default="", help="")
    parser.add_argument("--utt2LabelValid", type=str, default="", help="")
    
    parser.add_argument("--reverseGradient", type=strtobool, default=False, help="")

    # intermedia loss
    # parser.add_argument("--intermediate-ctc-weight", type=float, default=0, help="intermedia ctc weight")
    # parser.add_argument("--intermediate-ctc-layers", type=str, default="", help="intermedia ctc layer")
...
def main(cmd_args):
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            from espnet.asr.pytorch_backend.asr_train_multitask_accent import train
